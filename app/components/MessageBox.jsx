...
// 不可复用组件
const PureTrigger = PureRender(Trigger),
      PureNickname = PureRender(Nickname);

function Trigger(props){
    return (
        <span>
            <div className = {'trigger-'+props.dir+'-outer'}></div>
            <div className = {'trigger-'+props.dir+'-inner'}></div>
        </span>
    )
}
        ...
        <div className="Message-content">
            ...
            <PureTrigger dir = {dir}/>
            {
                ...
                <div className = {'Message-loading-'+dir}>
                    <img src = {config.LoadingImage} className="Message-loading-image"/>
                </div> : 
