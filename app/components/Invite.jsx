        ...
        <div className="Profile-container">
            ...
            <div className="Profile-body">
                ...
                <div className="UserProfile-margin">
                    ...
                    <ProfileButton text={language.copyLink} unicode='&#xe650;' color='#888' handleClick={handleCopyLink} />
                    <ProfileButton text={language.refreshLink} unicode='&#xe751;' color='#888' handleClick={handleRefreshLink} />
                </div>
            </div>
        </div>
    )
