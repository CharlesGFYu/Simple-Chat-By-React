...
class ContentEditableInput extends Component {
    ...
    // 这样处理会出现bug，也就是re-render时defaultContent变化并不会再次触发componentDidMount，当然除非组件重新Mount
    componentDidMount(){
    ...
    render(){
        const { defaultContent, controllerBtn, multiLine } = this.props;
